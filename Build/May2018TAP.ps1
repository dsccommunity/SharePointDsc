configuration May2018Tap
{
    ...
    Node $AllNodes.NodeName
    {
        ...
        {
            SourcePath = "https://spdsctap.blob.core.windows.net/spdsc/May2018.iso"
        ...
        xDownloadFile MSVCRT14
        {
            SourcePath = "https://download.microsoft.com/download/6/D/F/6DF3FF94-F7F9-4F0B-838C-A328D1A7D0EE/vc_redist.x64.exe"
        ...
        SPInstallPrereqs SharePointPrereqInstall
        {
            ...
            MSVCRT14 = $ConfigurationData.SharePoint.Settings.BinaryPath + "prerequisiteinstallerfiles\vc_redist.x64.exe"
            ...
            Ensure = "Present"
            DependsOn = "[xDownloadFile]MSVCRT14"
