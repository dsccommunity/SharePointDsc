...
'@
            ...
            {
                Context -Name "All methods throw exceptions as Access Services no longer exists in SharePoint Server Subscription Edition" -Fixture {
                    BeforeAll {
                        $testParams = @{
                            Name            = "Test Access Services App"
                            DatabaseServer  = "SQL.contoso.local"
                    ...
                    It "Should throw on the get method" {
                        { Get-TargetResource @testParams } | Should -Throw "Since SharePoint Server Subscription Edition the Access Services does no longer exists."
                    }

                    It "Should throw on the test method" {
                        { Test-TargetResource @testParams } | Should -Throw "Since SharePoint Server Subscription Edition the Access Services does no longer exists."
                    }

                    It "Should throw on the set method" {
                        { Set-TargetResource @testParams } | Should -Throw "Since SharePoint Server Subscription Edition the Access Services does no longer exists."
                    }
                }
            }
        }
