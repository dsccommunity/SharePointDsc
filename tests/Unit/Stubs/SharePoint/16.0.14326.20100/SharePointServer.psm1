...
function Add-SPCertificateNotificationContact {
  [CmdletBinding(SupportsShouldProcess=$true, ConfirmImpact='Medium')]
param(
    [Parameter(Mandatory=$true, Position=0)]
    [string]
...
function Add-SPDatabaseToAvailabilityGroup {
...
function Add-SPPeoplePickerDistributionListSearchDomain {
  [CmdletBinding(SupportsShouldProcess=$true, ConfirmImpact='Medium')]
param(
    [Parameter(Mandatory=$true, Position=0, ValueFromPipeline=$true, ValueFromPipelineByPropertyName=$true)]
    [ValidateNotNull()]
...
function Add-SPPeoplePickerSearchADDomain {
  [CmdletBinding(SupportsShouldProcess=$true, ConfirmImpact='Medium')]
param(
    [Parameter(Mandatory=$true, Position=0, ValueFromPipeline=$true, ValueFromPipelineByPropertyName=$true)]
    [ValidateNotNull()]
...
function Add-SPPeoplePickerServiceAccountDirectoryPath {
  [CmdletBinding(SupportsShouldProcess=$true, ConfirmImpact='Medium')]
param(
    [Parameter(Mandatory=$true, Position=0, ValueFromPipeline=$true, ValueFromPipelineByPropertyName=$true)]
    [ValidateNotNull()]
...
function Clear-SPCertificateNotificationContact {
  [CmdletBinding(SupportsShouldProcess=$true, ConfirmImpact='High')]
param(
    [Parameter(ValueFromPipeline=$true)]
    [object]
...
function Clear-SPPeoplePickerDistributionListSearchDomain {
  [CmdletBinding(SupportsShouldProcess=$true, ConfirmImpact='Medium')]
param(
    [Parameter(Mandatory=$true, Position=0, ValueFromPipeline=$true, ValueFromPipelineByPropertyName=$true)]
    [ValidateNotNull()]
...
function Clear-SPPeoplePickerSearchADDomain {
  [CmdletBinding(SupportsShouldProcess=$true, ConfirmImpact='Medium')]
param(
    [Parameter(Mandatory=$true, Position=0, ValueFromPipeline=$true, ValueFromPipelineByPropertyName=$true)]
    [ValidateNotNull()]
...
function Clear-SPPeoplePickerServiceAccountDirectoryPath {
  [CmdletBinding(SupportsShouldProcess=$true, ConfirmImpact='Medium')]
param(
    [Parameter(Mandatory=$true, Position=0, ValueFromPipeline=$true, ValueFromPipelineByPropertyName=$true)]
    [ValidateNotNull()]
...
function Export-SPCacheClusterConfig {
  [CmdletBinding(SupportsShouldProcess=$true, ConfirmImpact='Medium')]
param(
    [Parameter(Mandatory=$true, Position=0)]
    [ValidateNotNullOrEmpty()]
...
function Export-SPCertificate {
  [CmdletBinding(SupportsShouldProcess=$true, ConfirmImpact='Medium')]
param(
    [Parameter(ParameterSetName='Pfx', Mandatory=$true, Position=0, ValueFromPipeline=$true)]
    [Parameter(ParameterSetName='Cert/Pkcs7', Mandatory=$true, Position=0, ValueFromPipeline=$true)]
    [ValidateNotNull()]
    [object]
    ${Identity},
    ...
    [Parameter(ParameterSetName='Cert/Pkcs7', Mandatory=$true)]
    [ValidateSet('Cert','Pkcs7')]
    [string]
    ${Type},

    [Parameter(ParameterSetName='Pfx')]
    [ValidateSet('AES256','TripleDes')]
    [string]
    ${EncryptionType},

    [Parameter(ParameterSetName='Pfx')]
    [Parameter(ParameterSetName='Cert/Pkcs7')]
    [switch]
...
function Get-SPAvailabilityGroupStatus {
  [CmdletBinding()]
param(
    [string]
    ${Identity},
...
function Get-SPCacheClusterHealth {
  [CmdletBinding(SupportsShouldProcess=$true, ConfirmImpact='Medium')]
param(
    [Parameter(ValueFromPipeline=$true)]
    [object]
...
function Get-SPCacheClusterInfo {
  [CmdletBinding(SupportsShouldProcess=$true, ConfirmImpact='Medium')]
param(
    [Parameter(ValueFromPipeline=$true)]
    [object]
...
function Get-SPCacheHostConfig {
  [CmdletBinding(SupportsShouldProcess=$true, ConfirmImpact='Medium')]
param(
    [Parameter(Mandatory=$true)]
    [ValidateNotNullOrEmpty()]
...
function Get-SPCacheStatistics {
  [CmdletBinding(SupportsShouldProcess=$true, ConfirmImpact='Medium')]
param(
    [Parameter(Mandatory=$true)]
    [ValidateNotNullOrEmpty()]
...
function Get-SPCertificate {
  [CmdletBinding(DefaultParameterSetName='SearchFilters', SupportsShouldProcess=$true, ConfirmImpact='Medium')]
param(
    [Parameter(ParameterSetName='Identity', Mandatory=$true, Position=0, ValueFromPipeline=$true)]
    [object]
    ${Identity},

    [Parameter(ParameterSetName='SearchFilters')]
    [string]
    ${DisplayName},
...
function Get-SPCertificateNotificationContact {
  [CmdletBinding(SupportsShouldProcess=$true, ConfirmImpact='Medium')]
param(
    [Parameter(Position=0)]
    [string]
...
function Get-SPCertificateSettings {
  [CmdletBinding(SupportsShouldProcess=$true, ConfirmImpact='Medium')]
param(
    [Parameter(ValueFromPipeline=$true)]
    [object]
...
function Get-SPFlightsInfo {
  [CmdletBinding(SupportsShouldProcess=$true, ConfirmImpact='Medium')]
param(
    [Parameter(HelpMessage='Enter the specific flight Id.')]
    [string]
    ${FlightId},
...
function Get-SPPeoplePickerConfig {
  [CmdletBinding(SupportsShouldProcess=$true, ConfirmImpact='Medium')]
param(
    [Parameter(Mandatory=$true, Position=0, ValueFromPipeline=$true, ValueFromPipelineByPropertyName=$true)]
    [ValidateNotNull()]
...
function Get-SPPeoplePickerDistributionListSearchDomain {
  [CmdletBinding(SupportsShouldProcess=$true, ConfirmImpact='Medium')]
param(
    [Parameter(Mandatory=$true, Position=0, ValueFromPipeline=$true, ValueFromPipelineByPropertyName=$true)]
    [ValidateNotNull()]
...
function Get-SPPeoplePickerSearchADDomain {
  [CmdletBinding(SupportsShouldProcess=$true, ConfirmImpact='Medium')]
param(
    [Parameter(ParameterSetName='BasicParameterSet', Mandatory=$true, Position=0, ValueFromPipeline=$true, ValueFromPipelineByPropertyName=$true)]
    [Parameter(ParameterSetName='SpecificDomainParameterSet', Mandatory=$true, Position=0, ValueFromPipeline=$true, ValueFromPipelineByPropertyName=$true)]
    [ValidateNotNull()]
    [object]
    ${WebApplication},

    [Parameter(ParameterSetName='SpecificDomainParameterSet', Mandatory=$true)]
    [ValidateNotNullOrEmpty()]
    [string]
    ${DomainName},

    [Parameter(ParameterSetName='SpecificDomainParameterSet')]
    [switch]
    ${IsForest},
...
function Get-SPRemoteShareBlobStore {
  [CmdletBinding(SupportsShouldProcess=$true, ConfirmImpact='Medium')]
param(
    [Parameter(ParameterSetName='DefaultSet', Position=0, ValueFromPipeline=$true)]
    [ValidateNotNullOrEmpty()]
    ...
    [Parameter(ParameterSetName='ContentDatabase', Mandatory=$true, Position=0, ValueFromPipeline=$true)]
    [ValidateNotNullOrEmpty()]
    [object]
    ${ContentDatabase},

    [Parameter(ParameterSetName='ContentDatabase', Position=1, ValueFromPipeline=$true)]
    [ValidateNotNullOrEmpty()]
    [string]
    ${Name},
...
function Import-SPCacheClusterConfig {
  [CmdletBinding(SupportsShouldProcess=$true, ConfirmImpact='Medium')]
param(
    [Parameter(Mandatory=$true, Position=0)]
    [ValidateNotNullOrEmpty()]
...
param(
    ...
    [Parameter(Mandatory=$true)]
    [ValidateNotNull()]
    [ValidateSet('Default','EndEntity','Intermediate','Pending','Root')]
    [string]
    ${NewStore},
...
function New-SPCentralAdministration {
  [CmdletBinding()]
param(
    [Parameter(ParameterSetName='SetIisWebSiteBinding', Mandatory=$true, Position=0, ValueFromPipeline=$true, ValueFromPipelineByPropertyName=$true)]
    [int]
    ${Port},

    [Parameter(ParameterSetName='SetAuthProvider', Position=1, ValueFromPipeline=$true, ValueFromPipelineByPropertyName=$true)]
    [Parameter(ParameterSetName='SetIisWebSiteBinding', Position=1, ValueFromPipeline=$true, ValueFromPipelineByPropertyName=$true)]
    [ValidateSet('Kerberos','NTLM')]
    [string]
    ${WindowsAuthProvider},

    [Parameter(ParameterSetName='SetIisWebSiteBinding', Position=2, ValueFromPipeline=$true, ValueFromPipelineByPropertyName=$true)]
    [switch]
    ${SecureSocketsLayer},

    [Parameter(ParameterSetName='SetIisWebSiteBinding', ValueFromPipeline=$true, ValueFromPipelineByPropertyName=$true)]
    [Alias('Host')]
    [ValidateNotNullOrEmpty()]
    [string]
    ${HostHeader},
...
function New-SPCertificate {
  [CmdletBinding(DefaultParameterSetName='Default', SupportsShouldProcess=$true, ConfirmImpact='Medium')]
param(
    [Parameter(ParameterSetName='Default', Mandatory=$true)]
    [Parameter(ParameterSetName='RSA', Mandatory=$true)]
    [Parameter(ParameterSetName='ECC', Mandatory=$true)]
    [ValidateNotNullOrEmpty()]
    [string]
    ${FriendlyName},
...
function Register-SPRemoteShareBlobStore {
  [CmdletBinding(SupportsShouldProcess=$true, ConfirmImpact='Medium')]
param(
    [Parameter(Mandatory=$true, Position=0, ValueFromPipeline=$true)]
    [ValidateNotNullOrEmpty()]
...
function Remove-SPCertificateNotificationContact {
  [CmdletBinding(SupportsShouldProcess=$true, ConfirmImpact='High')]
param(
    [Parameter(Mandatory=$true, Position=0)]
    [string]
...
function Remove-SPConfigurationObject {
  [CmdletBinding(SupportsShouldProcess=$true, ConfirmImpact='High')]
param(
    [Parameter(Mandatory=$true, Position=0, ValueFromPipeline=$true)]
    [guid]
...
function Remove-SPDatabaseFromAvailabilityGroup {
  [CmdletBinding(DefaultParameterSetName='Default')]
param(
    [Parameter(Mandatory=$true, Position=0)]
    [string]
...
function Remove-SPPeoplePickerDistributionListSearchDomain {
  [CmdletBinding(SupportsShouldProcess=$true, ConfirmImpact='Medium')]
param(
    [Parameter(Mandatory=$true, Position=0, ValueFromPipeline=$true, ValueFromPipelineByPropertyName=$true)]
    [ValidateNotNull()]
...
function Remove-SPPeoplePickerSearchADDomain {
  [CmdletBinding(SupportsShouldProcess=$true, ConfirmImpact='Medium')]
param(
    [Parameter(Mandatory=$true, Position=0, ValueFromPipeline=$true, ValueFromPipelineByPropertyName=$true)]
    [ValidateNotNull()]
...
function Remove-SPPeoplePickerServiceAccountDirectoryPath {
  [CmdletBinding(SupportsShouldProcess=$true, ConfirmImpact='Medium')]
param(
    [Parameter(Mandatory=$true, Position=0, ValueFromPipeline=$true, ValueFromPipelineByPropertyName=$true)]
    [ValidateNotNull()]
...
function Renew-SPCertificate {
  [CmdletBinding(DefaultParameterSetName='Default', SupportsShouldProcess=$true, ConfirmImpact='Medium')]
param(
    [Parameter(ParameterSetName='Default', Mandatory=$true, Position=0)]
    [Parameter(ParameterSetName='RSA', Mandatory=$true, Position=0)]
    [Parameter(ParameterSetName='ECC', Mandatory=$true, Position=0)]
    [ValidateNotNull()]
    [object]
    ${Identity},
...
function Set-SPCertificateSettings {
  [CmdletBinding(SupportsShouldProcess=$true, ConfirmImpact='Medium')]
param(
    [string]
    ${OrganizationalUnit},
...
function Set-SPPeoplePickerConfig {
  [CmdletBinding(SupportsShouldProcess=$true, ConfirmImpact='Medium')]
param(
    [Parameter(Mandatory=$true, Position=0, ValueFromPipeline=$true, ValueFromPipelineByPropertyName=$true)]
    [ValidateNotNull()]
...
param(
    ...
    [Parameter(Mandatory=$true)]
    [ValidateSet('Disabled','Daily','Weekly','Monthly','FiscalYear')]
    [ValidateNotNullOrEmpty()]
    [string]
    ${TimephasedMode},
...
function Set-SPRemoteShareBlobStore {
  [CmdletBinding(SupportsShouldProcess=$true, ConfirmImpact='Medium')]
param(
    [Parameter(Mandatory=$true, Position=0, ValueFromPipeline=$true)]
    [ValidateNotNullOrEmpty()]
...
param(
    ...
    [Parameter(ParameterSetName='OIDCParameterSet', Mandatory=$true, Position=0, ValueFromPipeline=$true)]
    [ValidateNotNull()]
    [object]
    ${Identity},
...
param(
    ...
    [Parameter(ParameterSetName='UpdateIISSettings')]
    [switch]
    ${SecureSocketsLayer},
    ...
    [Parameter(ParameterSetName='UpdateIISSettings', ValueFromPipeline=$true)]
    [Parameter(ParameterSetName='UpdateMailSettings', ValueFromPipeline=$true)]
    [object]
    ${Certificate},
...
param(
    ...
    [Parameter(ParameterSetName='GracefulShutdown', Mandatory=$true, ValueFromPipeline=$true, ValueFromPipelineByPropertyName=$true)]
    [switch]
    ${Graceful},

    [Parameter(ParameterSetName='GracefulShutdown')]
    [switch]
    ${Force},
...
function Switch-SPBlobStorage {
  [CmdletBinding(SupportsShouldProcess=$true, ConfirmImpact='Medium')]
param(
    [Parameter(ParameterSetName='SQL', Mandatory=$true, Position=0, ValueFromPipeline=$true)]
    [ValidateNotNullOrEmpty()]
    [object]
    ${ContentDatabase},
    ...
    [Parameter(ParameterSetName='RemoteShareBlobStore', Mandatory=$true, Position=0, ValueFromPipeline=$true)]
    [object]
    ${RemoteShareBlobStore},
...
function Test-SPRemoteShareBlobStore {
  [CmdletBinding(SupportsShouldProcess=$true, ConfirmImpact='Medium')]
param(
    [Parameter(Mandatory=$true, Position=0, ValueFromPipeline=$true)]
    [ValidateNotNullOrEmpty()]
...
function Unregister-SPRemoteShareBlobStore {
  [CmdletBinding(SupportsShouldProcess=$true, ConfirmImpact='High')]
param(
    [Parameter(Mandatory=$true, Position=0, ValueFromPipeline=$true)]
    [ValidateNotNullOrEmpty()]
...
function Unregister-SPVssWriter {
  [CmdletBinding()]
param(
    [Parameter(ValueFromPipeline=$true)]
    [object]
...
function Update-SPDataRetrievalServiceConfig {
  [CmdletBinding(SupportsShouldProcess=$true, ConfirmImpact='Medium')]
param(
    [Parameter(ParameterSetName='WebApplication', Mandatory=$true, Position=0, ValueFromPipeline=$true, ValueFromPipelineByPropertyName=$true)]
    [ValidateNotNullOrEmpty()]
    ...
    [Parameter(ParameterSetName='Farm', Mandatory=$true, Position=0)]
    [switch]
    ${Farm},
...
function Update-SPFlightsConfigFile {
  [CmdletBinding(SupportsShouldProcess=$true, ConfirmImpact='Medium')]
param(
    [Parameter(Mandatory=$true, HelpMessage='Enter Flights config file path.')]
    [string]
    ${FilePath},
