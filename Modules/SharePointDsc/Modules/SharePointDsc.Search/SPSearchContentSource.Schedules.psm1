...
function Test-SPDSCSearchCrawlSchedule {
    ...
    switch ($CurrentSchedule.ScheduleType)
    {
        ...
        "Weekly" { 
            ...
            if ((Test-SPDSCObjectHasProperty -Object $DesiredSchedule -PropertyName "CrawlScheduleDaysOfWeek") -eq $true `
                -and $null -ne (Compare-Object -ReferenceObject $CurrentSchedule.CrawlScheduleDaysOfWeek.ToString().Split(', ', [System.StringSplitOptions]::RemoveEmptyEntries) `
        ...
        "Monthly" { 
            ...
            if ((Test-SPDSCObjectHasProperty -Object $DesiredSchedule `
                ...
                -and $null -eq (Compare-Object -ReferenceObject $CurrentSchedule.CrawlScheduleMonthsOfYear.ToString().Split(', ', [System.StringSplitOptions]::RemoveEmptyEntries) `
