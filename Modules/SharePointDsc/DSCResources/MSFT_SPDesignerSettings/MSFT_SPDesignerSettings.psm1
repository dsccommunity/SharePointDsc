        ...
        "WebApplication" {
            Invoke-SPDSCCommand -Credential $InstallAccount `
                ...
                else
                {
                    ...
                    {
                        $webapp.AllowCreateDeclarativeWorkflow = $params.AllowCreateDeclarativeWorkflow
                    }
                    ...
                    {
                        $webapp.AllowSaveDeclarativeWorkflowAsTemplate = $params.AllowSaveDeclarativeWorkflowAsTemplate
                    }
            ...
            if ((Test-SPDSCRunAsCredential -Credential $InstallAccount) -eq $true)
            {
                Invoke-SPDSCCommand -Credential $InstallAccount `
                    ...
                    if ($null -eq $site)
                    {
                        ...
                        if ($params.ContainsKey("AllowCreateDeclarativeWorkflow"))
                        {
                            $site.AllowCreateDeclarativeWorkflow = $params.AllowCreateDeclarativeWorkflow
                        }
                        ...
                        if ($params.ContainsKey("AllowSaveDeclarativeWorkflowAsTemplate"))
                        {
                            $site.AllowSaveDeclarativeWorkflowAsTemplate = $params.AllowSaveDeclarativeWorkflowAsTemplate
                        }
                    }
                }
            }
