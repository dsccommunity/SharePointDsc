...
function Set-TargetResource
{
    ...
    Invoke-SPDSCCommand -Credential $InstallAccount `
        ...
        {
            #remove existing app
            Remove-SPServiceApplication -Identity $appService 
            return
        }
        ...
        { 
            $setParams.MinimumTimeBetweenProviderRefreshes = `
                    New-TimeSpan -Days $setParams.MinimumTimeBetweenProviderRefreshes
        }
        if ($setParams.ContainsKey("MinimumTimeBetweenSearchQueries"))
        { 
            $setParams.MinimumTimeBetweenSearchQueries = `
                    New-TimeSpan -Days $setParams.MinimumTimeBetweenSearchQueries
        }
