...
function Get-DSCBlock
{
	...
	$dscBlock += "            PsDscRunAsCredential=`$FarmAccount`r`n"
	return $dscBlock
}
...
function Read-SPFarm{
	$module = Resolve-Path "..\..\DSCResources\MSFT_xSPCreateFarm\MSFT_xSPCreateFarm.psm1"
...
{
	$module = Resolve-Path "..\..\DSCResources\MSFT_xSPWebApplication\MSFT_xSPWebApplication.psm1"
	Import-Module $module
